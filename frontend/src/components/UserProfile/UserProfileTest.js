  ...
  return (
    <div>
      ...
      <div>
        ...
        <div className={ProfileStyle.userName}>User Name</div>
        <div className={ProfileStyle.nameField3}></div>
        <div className={ProfileStyle.egAlaaMohamed}>eg. alaa.mohamed</div>
      </div>

      <div>
        <div className={ProfileStyle.emailAddress}>Email Address</div>
        <div className={ProfileStyle.emailField}></div>
        <div className={ProfileStyle.mail}>
          <img className={ProfileStyle.icon} />
        </div>
      </div>
